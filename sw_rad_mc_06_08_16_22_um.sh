...
then
	...
	echo ' -------------------------------------------------------------------'
	run_scene_creator=0
	scene_dir="sessions/sw_rad_mc.02/"
	scene_file_in="$scene_dir/les_import_hr02.xml"
...
then
	...
	scene_dir="sessions/sw_rad_mc.04/"
	scene_file_out="$scene_dir/scene.uff"
	fi      
###########
...
#   orbit_file_in="models/orbit_dms/conf/ecsim_orbit_config_igor_sw_rad_no_up_down_mc.xml"    #ig
   ...
   lid_filter_config="models/upward/config_files/lid_filter_ARM_config.xml"
   lidar_config="models/upward/config_files/lidar_ARM_config.xml"
   mkdir -p "$scene_dir/satellite_"$time_sys_$1
...
run_sw_rad_block=1            #igor add-on, 1.6.2012., use it 2013 too
run_lw_rad_block=0
run_msi_block=0
...
# ON CIRRUS (all files in output folders)
...
# 3.9 and 11um
lw_rad_config="$scene_dir/lw_rad_config_msi_mc_channel_6_and_added_channel_4um.xml"         # channel at 3.9um (LW_1) and 11um (LW_61)
lw_rad_output="$outdir/lw_output_mc_39_and_11um_as_LW_1_and_LW_61um.nc"
...
sw_rad_config="$scene_dir/sw_rad_config_msi_mc.xml"         # channel at 3.9um (LW_1) and 11um (LW_61)
sw_rad_output="$outdir/sw_output_mc_06_08_16_22um.nc"
